...
static int
__bfp5_update_highest_flush_speed(struct bfp5_interface *bfp5_p) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	int idx;
...
static int
__bfp5_min_flush_speed_idx(struct bfp5_interface *bfp5_p) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	int idx, min_idx = 0;
...
static void
__bfp5_update_top_flush_speed(struct bfp5_interface *bfp5_p, double flush_speed) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	int min_speed_idx = __bfp5_min_flush_speed_idx(bfp5_p);
...
static double
__bfp5_update_last_flush_speed(struct bfp5_interface *bfp5_p) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	...
	__bfp5_update_highest_flush_speed(bfp5_p);

	// update top flush speed recoreds
	__bfp5_update_top_flush_speed(bfp5_p, flush_speed);

	return flush_speed;
}

static double
bfp5_get_last_flush_speed(struct bfp5_interface *bfp5_p) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
...
static double
__bfp5_update_avg_top_flush_speed(struct bfp5_interface *bfp5_p) {
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	...
	if(__bfp5_update_last_flush_speed(bfp5_p) < 0) {
		return avg_speed;
	}
...
static double
bfp5_guess_flush_load(struct bfp5_interface *bfp5_p) {
	char *log_header = "bfp5_guess_flush_load";
	double avg_flush_speed = __bfp5_update_avg_top_flush_speed(bfp5_p);
	double last_flush_speed = bfp5_get_last_flush_speed(bfp5_p);
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
...
static int
bfp5_get_flush_num(struct bfp5_interface *bfp5_p)
{
	char *log_header = "bfp5_flush_fuction";
	struct bfp5_private *priv_p = (struct bfp5_private *)bfp5_p->fp_private;
	...
	if (priv_p->p_block_noccupied > priv_p->p_buffertip ||
		...
		if(priv_p->p_lastflush_time > 0 && (priv_p->p_lastflush_mode == FLUSH_MODE_AGGRES)) {
			...
			// flush_load_ratio = last_flush_speed/avg_flush_speed;
			guess_flush_load = bfp5_guess_flush_load(bfp5_p);
...
struct bfp5_operations bfp5_op = {
	.bf_get_flush_num = bfp5_get_flush_num,
};

int
bfp5_initialization(struct bfp5_interface *bfp5_p, struct bfp5_setup *setup)
{
	char *log_header = "bfp5_initialization";
	struct bfp5_private *priv_p;

	nid_log_notice("%s: start ...", log_header);
	assert(setup);
	bfp5_p->fp_op = &bfp5_op;
	priv_p = x_calloc(1, sizeof(*priv_p));
	bfp5_p->fp_private = priv_p;
